...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Ruby client library for Agent Client Protocol (ACP)"
  spec.description = "A community Ruby client library for Agent Client Protocol (ACP)"
  spec.homepage = "https://github.com/nissyi-gh/acp_client_rb"
